...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './alumno.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALUMNO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ALUMNO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ALUMNO actions', async () => {
      const arg = { id: 12601 };
    ...
    it('dispatches UPDATE_ALUMNO actions', async () => {
      const arg = { id: 12601 };
    ...
    it('dispatches PARTIAL_UPDATE_ALUMNO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ALUMNO actions', async () => {
      const arg = 42666;
