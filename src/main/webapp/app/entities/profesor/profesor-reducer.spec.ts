...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './profesor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROFESOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROFESOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROFESOR actions', async () => {
      const arg = { id: 1907 };
    ...
    it('dispatches UPDATE_PROFESOR actions', async () => {
      const arg = { id: 1907 };
    ...
    it('dispatches PARTIAL_UPDATE_PROFESOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROFESOR actions', async () => {
      const arg = 42666;
