  ...
  return (
    <div>
      <h2 id="curso-heading" data-cy="CursoHeading">
        <Translate contentKey="tallerConstruccionApp.curso.home.title">Cursos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="tallerConstruccionApp.curso.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/curso/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="tallerConstruccionApp.curso.home.createLabel">Create new Curso</Translate>
          </Link>
        </div>
      </h2>
        ...
        {cursoList && cursoList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="tallerConstruccionApp.curso.id">ID</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="tallerConstruccionApp.curso.profesor">Profesor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="tallerConstruccionApp.curso.home.notFound">No Cursos found</Translate>
            </div>
          )
        )}
      </div>
